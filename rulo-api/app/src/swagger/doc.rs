...
#[openapi(
    paths(
        ...
        system::dept::handler::save_handler,
        system::dept::handler::remove_handler,
        system::dept::handler::update_handler,
        system::dept::handler::detail_handler,
        system::dept::handler::list_all_handler,
    ...
    components(
        schemas(
            ...
            system::dept::model::SysDept,
            system::dept::model::SysDeptSaveDto,
            system::dept::model::SysDeptUpdateDto,
            system::dept::model::SysDeptListDto,
