...
pub fn routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/update-bind-menus", post(handler::update_bind_menus_handler))
        .route("/update-bind-perms", post(handler::update_bind_perms_handler))
        ...
        .route("/list-perms", get(handler::list_bind_perms_handler))
}
